<?php
require_once __DIR__ . '/../src/authentification.php'; // Inclure l'authentification
?>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="#acti">
              <p class="p-nav-btn">Nos Activités</p>
            </a>
          </li>
          ...
          <div class="nav-btn">
            <li class="nav-item">
              <a class="nav-link" href="#moyens">
                <p class="p-nav-btn">Les Moyens Pédagogiques</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#equipe">
                <p class="p-nav-btn">L'Équipe</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#evenement">
                <p class="p-nav-btn">Évènements</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#tarifs">
                <p class="p-nav-btn">Tarifs</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#localisation">
                <p class="p-nav-btn">Localisation</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#formulaire">
                <p class="p-nav-btn">Devenir adhérent</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="#footer">
                <p class="p-nav-btn">Contact</p>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="login.php">
                <p class="p-nav-btn"><i class="ri-user-fill"></i></p>
              </a>
            </li>
          </div>
        ...
        <form class="d-flex">
          ...
          <iframe id="widget_autocomplete_preview" width="300" height="50" frameborder="0"
            src="https://meteofrance.com/widget/prevision/702600##081178"> </iframe>
        </form>
      </div>
    </div>
  </nav>
    ...
    <div id="blog-carousel" class="carousel slide" data-ride="carousel" data-bs-ride="carousel">
      ...
      <div class="carousel-inner carousel-sm">
        ...
        <div class="carousel-item">
          ...
          <!-- Ajout d'un div pour le texte avec les classes "carousel-caption" pour le style de Bootstrap -->
          <div class="carousel-caption d-none d-md-block">
            <h3 class="animate__animated animate__fadeIn">Pratiquez l'aviation légère dans un environnement exeptionnel
            </h3>
  ...
  <div class="container my-5 mx-auto">
    <div class="row text-center">
      <div class="col-md-6">
        ...
        <p>
          L'aéro-club est une association loi 1901, agréée Jeunesse et Sports, adhérente à la FFULM (Fédération
          Française d'ULM). Elle est enregistrée sous le numéro 04674 et agréée sous le numéro AS70986858. Son siège
          social est situé au 62, avenue de la République, 70200 Lure.
        </p><br>
      </div>
      <div class="col-md-6" data-bs-theme="dark">
        <ul class="list-group">
          ...
          <li class="list-group-item">Montage des ULM et de tout instrument de navigation (compas, radio, transpondeur)
          </li>
      ...
      <div class="col-md-3 mb-6">
        <div class="card" style="width: 18rem; height: 32.9rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Appareil volant dont le rotor assure la sustentation (et non la propulsion, comme dans
              l'hélicoptère).</p>
            <button class="btn btn-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight4"
              aria-controls="offcanvasRight4">En savoir plus</button>
      ...
      <div class="col-md-3 mb-4">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Un ULM pendulaire est un aéronef sustenté par une voilure rigide sous laquelle est
              généralement accrochée un chariot motorisé.</p>
            <button class="btn btn-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight2"
              aria-controls="offcanvasRight2">En savoir plus</button>
      ...
      <div class="col-md-3 mb-4">
        <div class="card" style="width: 18rem; height: 32.9rem;">
          ...
          <div class="card-body">
            ...
            <button class="btn btn-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight3"
              aria-controls="offcanvasRight3">En savoir plus</button>
      ...
      <div class="col-md-3 mb-4">
        <div class="card" style="width: 18rem;  height: 38.8rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Un ULM paramoteur est un aéronef sustenté par une voilure souple, de type parachute.
            </p><br><br><br><br><br>
            <button class="btn btn-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight1"
              aria-controls="offcanvasRight1">En savoir plus</button>
      ...
      <div class="col-md-3 mb-4">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <span class="badge rounded-pill text-bg-danger">Non disponible</span>
            <p class="card-text">Véhicule aérien sans moteur plus léger que l'air. Les aérostats ultra-légers sont
              caractérisés par leur poids extrêmement faible et leur capacité à rester en suspension dans l'air en
              exploitant la différence de densité entre l'hélium ou l'hydrogène.</p>
            <button class="btn btn-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight5"
              aria-controls="offcanvasRight5">En savoir plus</button>
      ...
      <div class="col-md-3 mb-4">
        <div class="card" style="width: 18rem; height: 38.8rem;">
          ...
          <div class="card-body">
            ...
            <span class="badge rounded-pill text-bg-danger">Non disponible</span>
            <p class="card-text">L'hélicoptère ultra léger est un hélico monomoteur dont la puissance maximale est
              inférieure ou égale à 116 CV (monoplace) ou à 143 CV (biplaces).</p><br><br><br>
            <button class="btn btn-secondary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasRight6"
              aria-controls="offcanvasRight6">En savoir plus</button>
      ...
      <div class="accordion" id="accordionPanelsStayOpenExample" style="max-width: 1000px; margin: 0 auto;">
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show"
            ...
            <div class="accordion-body">
              <img class="infrastructure" src="Ressources/baseulm.jpg" alt="image base ulm"> <br> <br>Explorez un espace
              aérien expansif qui offre une liberté totale pour les passionnés d'aviation. Notre domaine offre des
              possibilités infinies pour les pilotes, des décollages sans contraintes aux manœuvres aériennes créatives.

              Avec une surface totale de 45 hectares, notre site vous permet d'embrasser le ciel avec une perspective
              nouvelle et excitante. Que vous soyez débutant ou pilote expérimenté, notre domaine spacieux crée un
              environnement idéal pour perfectionner vos compétences et vivre des aventures aériennes mémorables.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <img class="infrastructure" src="Ressources/piste.jpg" alt="image piste"> <br> <br> Avec des pistes de 800
              et 450 mètres formant une configuration en X, notre site fournit des options diversifiées pour des
              décollages et atterrissages en toute sécurité.

              Cette disposition unique offre aux pilotes une flexibilité inégalée pour s'adapter à diverses conditions
              météorologiques et préférences de vol. Que vous soyez un novice cherchant à perfectionner vos compétences
              ou un pilote chevronné en quête de défis, nos deux pistes en X sont conçues pour répondre à toutes les
              aspirations aéronautiques.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <img class="infrastructure" src="Ressources/hydrosurface.jpg" alt="imagehydrosurface"> <br> <br> Explorez
              un espace idyllique où la piste d'eau s'étend sur 8 hectares, offrant des opportunités passionnantes pour
              les pilotes d'hydravions et d'ULM amphibies.

              Notre site exceptionnel vous permet de combiner la magie du vol avec l'adrénaline de l'atterrissage sur
              l'eau. Avec des installations modernes et un environnement naturel exceptionnel, notre hydrosurface crée
              une expérience inoubliable pour les amateurs d'aviation aquatique.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <img class="infrastructure" src="Ressources/hangar.jpg" alt="image hangar"> <br> <br> Nos trois hangars
              offrent une surface couverte de 4300 m², créant un espace ample et sécurisé pour le stockage et
              l'entretien de votre aéronef. Conçus pour répondre à divers besoins, ces hangars fournissent un refuge
              protecteur contre les intempéries et les éléments, assurant la préservation optimale de votre
              investissement. Avec un accès facile et rapide, notre équipe dédiée veille à la sécurité et à la
              fonctionnalité, offrant un environnement idéal pour les propriétaires d'ULM, d'avions légers et d'autres
              aéronefs.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <img class="infrastructure" src="Ressources/admin.jpg" alt="image administration"> <br> <br> Notre
              infrastructure moderne combine l'efficacité administrative avec la puissance de la technologie. Grâce à
              des installations informatisées, nous simplifions les processus, de l'inscription aux suivis de formation.

              Dans nos locaux administratifs, vous trouverez une équipe dévouée prête à vous guider à travers toutes les
              formalités, utilisant des systèmes informatisés pour assurer une gestion transparente et rapide. Que vous
              soyez étudiant, pilote ou visiteur, notre environnement administratif informatisé garantit une expérience
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseSix" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <img class="infrastructure" src="Ressources/simulateur.jpg" alt="image administration"> <br> Découvrez une
              expérience d'apprentissage exceptionnelle dans notre salle de cours multimédia équipée d'un simulateur de
              vol ultramoderne. Grâce à des cours interactifs et des séances de simulation réalistes, vous développerez
              vos compétences de pilotage avec confiance.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseSeven" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <img class="infrastructure" src="Ressources/atelier.jpg" alt="image atelier réparation"> <br> <br>
              Explorez notre atelier d'entretien et de réparation dédié aux ULM, offrant une expertise technique pour
              garantir la fiabilité et la performance optimale de votre aéronef ! Avec des installations modernes et une
              équipe qualifiée, nous sommes engagés à fournir des services d'entretien de première classe pour répondre
              à tous vos besoins.

              Notre atelier est équipé pour traiter une gamme variée de travaux, de l'entretien régulier aux réparations
              plus complexes. Nous comprenons l'importance de la sécurité et de la qualité, et notre équipe d'experts
              s'assurera que votre ULM est toujours prêt à prendre les airs en toute confiance.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseEight" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <img class="infrastructure" src="Ressources/resto.jpg" alt="image restauration"> <br> <br> Profitez de nos
              capacités d'accueil et de restauration sur place, ajoutant une dimension confortable à votre expérience
              aéronautique ! Notre site est équipé pour vous offrir un espace accueillant où vous pourrez vous détendre,
              socialiser et savourer des moments après vos vols.

              Avec des installations de restauration sur place, nous veillons à ce que vous puissiez apprécier une
              variété de repas et de rafraîchissements sans quitter le site. Que vous soyez pilote, étudiant ou
              visiteur, nos capacités d'accueil créent une atmosphère conviviale où vous pouvez partager des anecdotes,
              échanger des expériences et célébrer votre passion commune pour l'aviation.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item">
          ...
          <div id="panelsStayOpen-collapseNine" class="accordion-collapse collapse"
            ...
            <div class="accordion-body">
              <img class="infrastructure" src="Ressources/wifi.jpg" alt="image wifi"> <br> <br> Profitez de la
              connectivité totale avec notre connexion Wi-Fi gratuite disponible sur toute la base ! Que vous soyez un
              étudiant en pause entre les cours, un pilote en attente de son vol, ou un visiteur explorant nos
              installations, notre réseau Wi-Fi gratuit vous permet de rester connecté où que vous soyez sur la base.
            </div>
          </div>
          ...
          <div class="accordion-item">
            ...
            <div id="panelsStayOpen-collapseTen" class="accordion-collapse collapse"
              ...
              <div class="accordion-body">
                ...
                <ul class="list-group">
                  <li class="list-group-item">Équipé d’une kitchenette, d’une salle de bain (lavabo, douche, W.C.),
                    télévision, lit en 140</li>
                ...
                <br> <br>
                <ul class="list-group">
                  <li class="list-group-item">Équipée d’une salle de bain (lavabo, douche, W.C.), télévision, lit en 140
                  </li>
                  <li class="list-group-item">Draps fournis.</li>
          ...
          <div class="row justify-content-center mt-8">
            ...
            <div class="col-md-4 mb-6">
              <div class="card" style="width: 22rem; height: 38rem;">
                <a href="https://mondialulm.fr/fr/"> <img src="Ressources/event1.png" class="card-img-top"
                    alt="image evenement"></a>
                <div class="card-body">
                  <h5 class="card-title">Mondial de l'ULM 2023 à Blois</h5>
                  <br>

                  <p class="card-text"> Le Salon mondial de l'ULM 2023 a marqué un moment mémorable, rassemblant l'élite
                    de l'aviation légère pour présenter les dernières innovations, technologies et tendances, offrant
                    ainsi une vision passionnante de l'avenir de l'aviation légère à l'échelle mondiale.</p>
                  <a href="https://mondialulm.fr/fr/"> <button class="btn btn-secondary" type="button">En savoir
                      plus</button></a>
            ...
            <div class="col-md-4 mb-6">
              <div class="card" style="width: 22rem; height: 38rem;">
                <a href="https://www.vosgesmatin.fr/vosges/2013/07/28/envolee-d-ulm-a-remomeix"> <img
                    src="Ressources/event2.jpg" class="card-img-top" alt="évènement ulm à Remomeix" /> </a>
                <div class="card-body">
                  <h5 class="card-title">Envolée d’ULM à Remomeix </h5>
                  <br>

                  <p class="card-text">Rassemblant environ 300 participants, le « Tour ULM » a pris son départ hier
                    matin à l’aérodrome. À l’issue de plusieurs escales en Allemagne, les pilotes seront de retour
                    vendredi.</p><br><br>
                  <a href="https://www.vosgesmatin.fr/vosges/2013/07/28/envolee-d-ulm-a-remomeix"> <button
                      class="btn btn-secondary" type="button">En savoir plus</button></a>
            ...
            <div class="col-md-4 mb-4">
              <div class="card" style="width: 22rem; height: 38rem;">
                <a href="https://www.lejsl.com/edition-macon/2018/07/21/le-tour-ulm-est-parti-de-macon-ce-samedi-matin">
                  <img src="Ressources/event3.jpg" class="card-img-top" alt="tour ulm mâcon" /> </a>
                <div class="card-body">
                  <h5 class="card-title">Le Tour ULM est parti de Mâcon ce samedi matin</h5>

                  Près de 140 ULM - multiaxes, pendulaires et autogyres - participant au 23e Tour ULM, organisé par la
                  FFPLUM sont partis de l’aérodome de Mâcon, samedi matin. Après une semaine d’épreuves qui les mèneront
                  en Belgique et sur les côtes normandes.</p><br>
                  <a
                    href="https://www.lejsl.com/edition-macon/2018/07/21/le-tour-ulm-est-parti-de-macon-ce-samedi-matin">
                    <button class="btn btn-secondary" type="button">En savoir plus</button></a>
            ...
            <div class="row">
              <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="carousel slide" data-ride="carousel" id="carousel-formation">
                          ...
                          <div class="carousel-item active">
                            <div class="card" style="width: 30rem; height: 18rem; margin: 0 auto;">
                              ...
                              <div class="card-body">
                                ...
                                <button class="btn btn-secondary" onclick="redirigerVersleFormulaire()"
                        ...
                        <a class="carousel-control carousel-control-prev bg-secondary " style="width:"
                          href="#carousel-formation" role="button" data-slide="prev">
                          <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                          <span class="sr-only"></span>
                        </a>
                        <a class="carousel-control carousel-control-next bg-secondary" href="#carousel-formation"
                    ...
                    <iframe
                      src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2687.500055775827!2d6.545493728266803!3d47.655289912740024!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x479243ff7a705239%3A0x4d2f79be7103e0b6!2sA%C3%A9ro-club%20de%20Flotey-Les-Lures!5e0!3m2!1sfr!2sfr!4v1704562011553!5m2!1sfr!2sfr"
                ...
                <div class="container">
                    ...
                    <footer id="footer" class="footer-bs">
                      <div class="row">
                        <div class="col-md-3 footer-brand animated fadeInLeft">
                          ...
                          <p>© 2024 Aéro-Club de Frotey-les-Lure appelé sous le terme ACF2L, Tous les droits réservés
                          </p>
                        </div>
                        <div class="col-md-4 footer-nav animated fadeInUp">
                          ...
                          <div class="col-md-6">
                            <ul class="pages">
                              <!-- Liens modaux -->
                              <li><a class="footer-title" href="#" data-toggle="modal" data-target="#aProposModal">À
                                  propos</a></li>
                              <li><a class="footer-title" href="#" data-toggle="modal"
                                  data-target="#confidentialiteModal">Politique de confidentialité</a></li>
                        ...
                        <div class="col-md-3 footer-ns animated fadeInRight">
                          ...
                          <p>
                            <a href="#localisation"> <button type="button"
                                class="btn btn-secondary">Retrouvez-nous</button> </a>
                        </div>
                        </p>
                      </div>
                  </div>
                  ...
                  <!-- Modal À propos -->
                  <div class="modal fade" id="aProposModal" tabindex="-1" role="dialog"
                    aria-labelledby="aProposModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <p>L’Aéro-Club de Frotey-les-Lure appelé sous le terme ACF2L Il a pour origine la fusion de
                            l’Aéro-Club de l’Ill siégeant à Vesoul et de l’Aéro-Club Marin-La-Meslée, siégeant à
                            Frotey-les-Lure. au sein de l’Association des Aéro-Clubs de la Bourgogne-Franche-Comté.
                            L’aéro-club est une Association Loi 1901, agréée Jeunesse et Sports , adhérente à la FFULM (
                            Fédération Française d’ULM) . </p>
                        </div>
                  ...
                  <div class="modal fade" id="confidentialiteModal" tabindex="-1" role="dialog"
                    aria-labelledby="confidentialiteModalLabel" aria-hidden="true">
                    <div class="modal-dialog" role="document">
                      <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                          ...
                          <p>Les informations personnelles concernant les visiteurs de notre site sont confidentielles,
                            y compris leur identité. Nous nous engageons sur l'honneur à respecter les conditions
                            légales de confidentialité applicables en France et a ne pas divulguer ces informations à
                            des tiers.</p>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-secondary" data-dismiss="modal">Fermer</button>
